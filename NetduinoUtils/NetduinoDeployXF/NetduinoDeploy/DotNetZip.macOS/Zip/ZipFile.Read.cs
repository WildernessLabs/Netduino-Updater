...
namespace Ionic.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        private static void ReadIntoInstance(ZipFile zf)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    long bytesRead = SharedUtils.FindSignature(s, (int)ZipConstants.EndOfCentralDirectorySignature);
                    if (bytesRead != -1)
                        success = true;
                    else
                    {
        ...
        private static void Zip64SeekToCentralDirectory(ZipFile zf)
        {
            ...
            uint datum = (uint)Ionic.Zip.SharedUtils.ReadInt(s);
        ...
        {
            uint datum = (uint)SharedUtils.ReadInt(s);
            return datum;
        }
        ...
        private static void ReadCentralDirectory(ZipFile zf)
        {
            ...
            while ((de = SharedUtils.ReadDirEntry(zf, previouslySeen)) != null)
            {
                de.ResetDirEntry();
        ...
        private static void ReadCentralDirectoryFooter(ZipFile zf)
        {
            ...
            if (signature == ZipConstants.Zip64EndOfCentralDirectoryRecordSignature)
            {
                ...
                signature = Ionic.Zip.SharedUtils.ReadSignature(s);
